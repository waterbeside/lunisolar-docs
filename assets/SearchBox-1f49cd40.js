import{a as E}from"./app-2ca187f9.js";import{r as y,h as T,w as H,c as C,a1 as w,B as A,_ as N,V as g,W as h,a2 as O,a3 as _,X as f,a4 as b,a5 as G,a6 as k,a7 as Y,a8 as S,a9 as v,aa as I}from"./framework-b070b9df.js";const z=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
返回节气字符串 string 静态方法 static method ---
--- getNames()
...
先天八卦即伏羲八卦，後天八卦即文王八卦 先天八卦与後天八卦`}]},{path:"/guide/functional/",title:"功能与使用",pathLocale:"/",contents:[]},{path:"/guide/functional/branch.html",title:"地支",pathLocale:"/",contents:[{header:"地支",slug:"地支",content:""},{header:"取得地支实例",slug:"取得地支实例",content:`通过SB实例的branch属性可取得天干对象Branch
// 例如，取得年柱的地支
...
Direction24`}]},{path:"/reference/gods/",title:"吉凶神煞",pathLocale:"/",contents:[{header:"吉凶神煞",slug:"吉凶神煞",content:""}]},{path:"/reference/gods/godsDesc.html",title:"神煞吉凶",pathLocale:"/",contents:[{header:"神煞吉凶",slug:"神煞吉凶",content:"...编撰中"}]},{path:"/reference/gods/godBuilder/",title:"神煞立成",pathLocale:"/",contents:[{header:"神煞立成",slug:"神煞立成",content:""}]},{path:"/reference/gods/godBuilder/dayGods.html",title:"日神",pathLocale:"/",contents:[{header:"日神",slug:"日神",content:""},{header:"日神取一定干支者",slug:"日神取一定干支者",content:""},{header:"日神按年取干支者",slug:"日神按年取干支者",content:""},{header:"日神按月取日数者",slug:"日神按月取日数者",content:""},{header:"日神按朔取日数者",slug:"日神按朔取日数者",content:""},{header:"日神按节气取数者",slug:"日神按节气取数者",content:""}]},{path:"/reference/gods/godBuilder/hourGods.html",title:"时神",pathLocale:"/",contents:[{header:"时神",slug:"时神",content:""},{header:"时神从日干起者",slug:"时神从日干起者",content:""},{header:"时神从日支起者",slug:"时神从日支起者",content:""},{header:"时神随月将及日干支者",slug:"时神随月将及日干支者",content:""},{header:"貴登天門",slug:"貴登天門",content:""},{header:"九醜",slug:"九醜",content:""},{header:"时神随日六旬者",slug:"时神随日六旬者",content:""}]},{path:"/reference/gods/godBuilder/monthGods.html",title:"月神",pathLocale:"/",contents:[{header:"月神",slug:"月神",content:""},{header:"月神取月建三合者",slug:"月神取月建三合者",content:""},{header:"月神随四序者",slug:"月神随四序者",content:""},{header:"月神随月建顺行者",slug:"月神随月建顺行者",content:""},{header:"月神随建旺取墓辰者",slug:"月神随建旺取墓辰者",content:""},{header:"月神随月建三合逆行一方者",slug:"月神随月建三合逆行一方者",content:""},{header:"月神随四序行三合者",slug:"月神随四序行三合者",content:""},{header:"月神随四时行三合者纳甲者",slug:"月神随四时行三合者纳甲者",content:""},{header:"月神随月建行纳甲六辰者",slug:"月神随月建行纳甲六辰者",content:""},{header:"月神随月建逆行一方者",slug:"月神随月建逆行一方者",content:""},{header:"月神随月建三合顺行一方者",slug:"月神随月建三合顺行一方者",content:""},{header:"月神随孟仲季顺行三支者",slug:"月神随孟仲季顺行三支者",content:""},{header:"月神随月建阴阳顺行六辰者",slug:"月神随月建阴阳顺行六辰者",content:""},{header:"月神随月将逆行者",slug:"月神随月将逆行者",content:""},{header:"月神随月建行阴阳六辰者",slug:"月神随月建行阴阳六辰者",content:""},{header:"月神取月建生比者",slug:"月神取月建生比者",content:""},{header:"月神从厌建起者",slug:"月神从厌建起者",content:""}]},{path:"/reference/gods/godBuilder/yearGods.html",title:"年神",pathLocale:"/",contents:[{header:"年神",slug:"年神",content:""},{header:"年神随岁干起者",slug:"年神随岁干起者",content:""},{header:"年神随岁干取纳甲卦变者",slug:"年神随岁干取纳甲卦变者",content:""},{header:"年神随岁支顺行者",slug:"年神随岁支顺行者",content:""},{header:"年神随岁支退行者",slug:"年神随岁支退行者",content:""},{header:"年神从岁支三合者",slug:"年神从岁支三合者",content:""},{header:"年神随岁支顺行一方者",slug:"年神随岁支顺行一方者",content:""}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],j="update-vuepress-plugin-full-text-search2-search-index";var M=y(z),q=T(()=>{const n=new Map;for(const e of M.value)n.set(e.path,e);return n});import.meta.webpackHot&&(__VUE_HMR_RUNTIME__[j]=n=>{M.value=n});function K(n){const e=y([]);let l=null;return H(n,()=>{l&&clearTimeout(l),l=setTimeout(a,100)}),e;function a(){const i=n.value.toLowerCase().trim();if(!i){e.value=[];return}const o=new Map,t=new Set;for(const r of M.value)for(const s of F(r,i)){t.add(s.parentPageTitle);let u=o.get(s.parentPageTitle);u||(u=[],o.set(s.parentPageTitle,u)),u.push(s)}const c=[...t].sort((r,s)=>{const u=o.get(r);return o.get(s).length-u.length});e.value=[...o].flatMap(([,r])=>r).sort((r,s)=>r.parentPagePriority-s.parentPagePriority||c.indexOf(r.parentPageTitle)-c.indexOf(s.parentPageTitle)||r.priority-s.priority)}}function*F(n,e){const l=D(n.title,e);if(l){yield{path:n.path,parentPageTitle:L(n),title:n.title,display:l,page:n,content:null,parentPagePriority:1,priority:1};return}for(const a of n.contents){const i=D(a.header,e);if(i){yield{path:n.path+(a.slug?`#${a.slug}`:""),parentPageTitle:L(n),title:n.title,display:i,page:n,content:null,parentPagePriority:10,priority:2};continue}const o=D(a.content,e);o&&(yield{path:n.path+(a.slug?`#${a.slug}`:""),parentPageTitle:L(n),title:n.title,display:[{type:"header",str:`${a.header}
`},...o],page:n,content:null,parentPagePriority:10,priority:10})}}function L(n){const e=n.path.split("/");let l="/";return e[1]&&(l=`/${e[1]}/`),(q.value.get(l)||n).title}function D(n,e){const l=[];let a=0;const i=n.toLowerCase().replace(/\s/gu," ");let o=0,t=i.indexOf(e,o);if(t<0)return null;for(;t>=0;){const r=t+e.length;if(c(n.slice(o,t),"normal"),c(n.slice(t,r),"highlight"),o=r,t=i.indexOf(e,o),a>100)break}return c(n.slice(o),"normal"),l.filter(r=>r.str);function c(r,s){let u=r;s==="normal"&&u.length>100&&a===0&&(u=`… ${u.slice(-10)}`);let m=!1;if(a+u.length>100){if(l.some(p=>p.type==="ellipsis"))return;u=u.slice(0,Math.max(100-a,1)),m=!0}l.push({type:s,str:u}),a+=u.length,m&&(l.push({type:"ellipsis",str:" …"}),a+=2)}}const U={},$=C({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>U}},setup(n){const{locales:e}=w(n),l=y(""),a=y(!1),i=y(-1),o=K(l),t=T(()=>l.value&&a.value&&o.value.length),c=A(),r=E(),s=T(()=>e.value[r.value]??{});function u(){if(!t.value)return;let d=i.value-1;d<0&&(d=o.value.length-1),p(d)}function m(){if(!t.value)return;let d=i.value+1;d>=o.value.length&&(d=0),p(d)}function p(d){i.value=d}function x(){i.value=-1}function P(d){if(!t.value)return;const B=o.value[d];B&&c.push(B.path)}return{query:l,focused:a,focusIndex:i,suggestions:o,activeSuggestion:t,onUp:u,onDown:m,focus:p,unfocus:x,go:P,locale:s}}});const Z={class:"search-box",role:"search"},V=["placeholder"],R=["onMousedown","onMouseenter"],W=["href"],J={key:0,class:"parent-page-title"},X={class:"suggestion-row"},Q={class:"page-title"},nn={class:"suggestion-content"};function en(n,e,l,a,i,o){return g(),h("div",Z,[O(f("input",{ref:"input","onUpdate:modelValue":e[0]||(e[0]=t=>n.query=t),"aria-label":"Search",class:b({focused:n.focused}),placeholder:n.locale.placeholder??"Search",autocomplete:"off",spellcheck:"false",onFocus:e[1]||(e[1]=()=>n.focused=!0),onBlur:e[2]||(e[2]=()=>n.focused=!1),onKeyup:[e[3]||(e[3]=G(t=>n.go(n.focusIndex),["enter"])),e[4]||(e[4]=G((...t)=>n.onUp&&n.onUp(...t),["up"])),e[5]||(e[5]=G((...t)=>n.onDown&&n.onDown(...t),["down"]))]},null,42,V),[[_,n.query]]),n.activeSuggestion?(g(),h("ul",{key:0,class:"suggestions",onMouseleave:e[7]||(e[7]=(...t)=>n.unfocus&&n.unfocus(...t))},[(g(!0),h(k,null,Y(n.suggestions,(t,c)=>(g(),h("li",{key:c,class:b(["suggestion",{focused:c===n.focusIndex}]),onMousedown:r=>n.go(c),onMouseenter:r=>n.focus(c)},[f("a",{href:t.path,onClick:e[6]||(e[6]=I(()=>{},["prevent"]))},[t.parentPageTitle&&(!n.suggestions[c-1]||n.suggestions[c-1].parentPageTitle!==t.parentPageTitle)?(g(),h("div",J,S(t.parentPageTitle),1)):v("v-if",!0),f("div",X,[f("div",Q,S(t.title||t.path),1),f("div",nn,[(g(!0),h(k,null,Y(t.display,(r,s)=>(g(),h("span",{key:s,class:b(r.type)},S(r.str),3))),128))])])],8,W)],42,R))),128))],32)):v("v-if",!0)])}const an=N($,[["render",en],["__scopeId","data-v-c13c90dc"],["__file","SearchBox.vue"]]);export{an as default};
