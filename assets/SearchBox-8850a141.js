import{a as H}from"./app-b53ab751.js";import{r as y,h as T,w as E,c as C,a2 as w,B as A,_ as N,V as g,W as h,a3 as O,a4 as _,X as f,a5 as b,a6 as G,a7 as k,a8 as Y,a9 as S,a1 as v,aa as I}from"./framework-d1125686.js";import"./preload-helper-101896b7.js";const j=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
/** * @return {string[]} */
lunisolar.Stem.getNames()`}]},{path:"/guide/plugins/",title:"插件 plugins",pathLocale:"/",contents:[{header:"插件 plugins",slug:"插件-plugins",content:`基本说明
胎神占方
五行纳音
神煞宜忌
...
加载char8ex插件时，将自动加载takeSound插件（五行纳音插件），所以请不要再重复加takeSound`},{header:"快速上手",slug:"快速上手",content:""},{header:"安装",slug:"安装",content:`由于八字增强插件虽要用到五行纳音，所以须同时安装五行纳音插件 pnpm add @lunisolar/plubin-char8ex @lunisolar/plugin-takesound yarn add @lunisolar/plubin-char8ex @lunisolar/plugin-takesound npm install @lunisolar/plubin-char8ex @lunisolar/plugin-takesound 注意
...
其中天干地支与胎神位置的规律可用以下口诀记忆： ----天干六甲胎神歌---- 甲己之日占在門，乙庚碓磨休移动。 丙辛廚灶莫相干，丁壬倉庫忌修弄。 戊癸房床若移整，犯之孕妇堕孩童。 ----地支六甲胎神歌---- 子午二日碓须忌，丑未廁道莫修移。 寅申火爐休要动，卯酉大門修当避。 辰戌雞棲巳亥床，犯着六甲身堕胎。`},{header:"安装",slug:"安装",content:`pnpm add @lunisolar/plubin-fetalgod yarn add @lunisolar/plubin-fetalgod npm install @lunisolar/plubin-fetalgod 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
...
sb.takeSoundE5 属性返回纳音五行的Element5实例`},{header:"安装",slug:"安装",content:`pnpm add @lunisolar/plubin-takesound yarn add @lunisolar/plubin-takesound npm install @lunisolar/plubin-takesound 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
...
正因为神煞和宜忌的数据复杂烦琐，为了方便维护和以免影响lunisolar的打包体积，故TheGods作为一个lunisolar的插件开发。`},{header:"2 快速上手",slug:"_2-快速上手",content:""},{header:"安装",slug:"安装",content:`pnpm install @lunisolar/plubin-char8ex yarn add @lunisolar/plubin-char8ex npm install @lunisolar/plubin-char8ex 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
