import{a as H}from"./app-b1be89f9.js";import{r as y,h as T,w as P,c as E,a2 as U,B as O,_ as A,V as g,W as h,a3 as w,a4 as N,X as f,a5 as b,a6 as G,a7 as Y,a8 as k,a9 as S,a1 as C,aa as _}from"./framework-d1125686.js";import"./preload-helper-101896b7.js";const I=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
正因为神煞和宜忌的数据复杂烦琐，为了方便维护和以免影响lunisolar的打包体积，故TheGods作为一个lunisolar的插件开发。`},{header:"2 快速上手",slug:"_2-快速上手",content:""},{header:"安装",slug:"安装",content:`pnpm install @lunisolar/plugin-char8ex yarn add @lunisolar/plugin-char8ex npm install @lunisolar/plugin-char8ex 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
