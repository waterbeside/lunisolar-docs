import{a as H}from"./app-2d171296.js";import{r as M,h as G,w as P,c as _,a2 as E,B as U,_ as w,V as g,W as h,a3 as O,a4 as A,X as p,a5 as k,a6 as D,a7 as v,a8 as Y,a9 as y,a1 as B,aa as F}from"./framework-d1125686.js";import"./preload-helper-101896b7.js";const N=[{path:"/",title:"Lunisolar.js 使用Typescript编写的专业农历库",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
返回类型 lunar
阴历数据对象 Lunar char8
八字对象 Char8 markers 日期备注对象（可用于节日、备忘等） Markers solarTerm
...
子
八字日柱地支 cYn 0 - 59
八字年柱干支序号 (比cY 多个 n，凡干支相关的，想取序号，在后补个n即可) cYsn 0 - 9
八字年柱天干序号 (比cYs 多个 n) cYbn 0 - 11
八字年柱地支序号 (比cYb 多个 n) cMn 0 - 59
八字月柱干支序号 cMsn 0 - 9
八字月柱天干序号 cMbn 0
八字月柱地支序号 cDn 0 - 59
八字日柱干支序号 cDsn 0 - 9
...
am / pm
上/下午，小写 dR 1 ~ 5
该天的星期几在该月第 多少 次出现 dRr 1 ~ 5
该天的星期几在该月倒数第 多少 次出现 Lunisolar.diff() unit可选值参考 单位
缩写
描述 lunarYear
lY
阴历年 lunarMonth
...
): typeof lunisolar`},{header:"lunisolar.Lunar",slug:"lunisolar-lunar",content:"返回Lunar构造函数"},{header:"lunisolar.Char8",slug:"lunisolar-char8",content:"返回Char8构造函数"},{header:"lunisolar.SB",slug:"lunisolar-sb",content:"返回SB构造函数"},{header:"lunisolar.Stem",slug:"lunisolar-stem",content:"返回Stem构造函数"},{header:"lunisolar.Branch",slug:"lunisolar-branch",content:"返回Branch构造函数"},{header:"lunisolar.Element5",slug:"lunisolar-element5",content:"返回Element5构造函数"},{header:"lunisolar.Lunisolar",slug:"lunisolar-lunisolar",content:"返回Lunisolar构造函数"},{header:"lunisolar.Trigram8",slug:"lunisolar-trigram8",content:"返回Trigram8构造函数"},{header:"lunisolar.Direction24",slug:"lunisolar-direction24",content:"返回Direction24构造函数"},{header:"lunisolar.Markers",slug:"lunisolar-markers",content:"返回Markers构造函数"}]},{path:"/api/markers.html",title:"Markers 日期备注类",pathLocale:"/",contents:[{header:"Markers 日期备注类",slug:"markers-日期备注类",content:`通过lunisolar.Markers取得Markers类
通过lunisolar().markers取得markers实例`},{header:"1 静态方法",slug:"_1-静态方法",content:`属性或方法
描述
参数
返回类型 静态方法 add(markersSetting, tag)
全局添加markers
markersSetting: MarkersSetting 节日、备注设置列表。 tag?: string | string[] 对markers补充一个或多个标签，非必填
Markers类 clean()
清除所有全局添加markers Markers类 cleanFnList()
markers全局设置时，分为formatList,和fnList两种， 此方法清除所有以fnList方式添加markers Markers类 remove(format, matcher, names)
移除指定的markers
format: string 日期的格式化方式，如'MMDD' matcher?: string 指定的日期，如'0101'， 非必填 names?: string | string[] 指定的名称，非必填。 * 如果只填format参数，所有与format一致的markers会全部删除，如果format与matcher参数都填上，如format: 'MMDD', matcher: '0303', 则会把lunisolar().format('MMDD')为0303的所有markers删除， 如果 name参数也指定，指会只删除指定name的marker
Markers类 removeByTag(tag)
移除指定标签的marker
tag: string | string[] 指定标签名，可以以字符串形式指定一个，或以数组形式指定多个
Markers类 removeByName(name)
移除指定标签的marker
name: string | string[] 指定的marker名称，可以以字符串形式指定一个，或以数组形式指定多个
Markers类`},{header:"2 实例方法",slug:"_2-实例方法",content:`属性或方法
描述
参数
返回类型 constructor(lsr)
构造方法， 构建实例时，会从全局设置的markers里找到匹配的marker添加到本实例
lsr: Lunisolar 存入一个lunisolar实例。
Markers实例 实例方法 add(marker, tag)
为当前实例添加一个或多个marker
marker: MarkersSettingItem | MarkersSettingItem[] 一个或多个的marker设置 tag:? string | string[] 补充的标签
返回当前markers实例 remove(name, isTag, flag)
为当前实例移除一个或多个marker
name: string | string[] 要移除的marker名称或该marker的标签名称,可以以数组形式输入多个名称 isTag?: boolean 参数name是否指定为marker的标签名称，默认为false，即指定为marker名称。 flag?: 0 | 1 | 2 1: 只移除从全局设定进本实例的markers, 2： 只移除通过本实例add方法加进来的markers, 0: 包括1和2。默认为0
返回当前markers实例 clean(flag)
清除当前实例的markers
flag:? 0 | 1 | 2 1: 只清除从全局设定进本实例的markers，2： 只清除通过本实例add方法加进来的markers, 0：包括1和2, 默认为0
返回当前markers实例 reset()
重置本实例， 执行此方法时，将清除所有在本实例单独添加的markers, 并重新在全局设置的markers里找到匹配的marker添加到本实例 返回当前markers实例 list
取得当前实例的marker列表 StoreMarker[] filter(fn)
对当前实例的marker列表进行筛选
fn: MarkerFilterDict | MarkersFilterFn
StoreMarker[] find(fn)
对当前实例的marker列表进行查找，并返回一个marker
fn: MarkerFilterDict | MarkersFilterFn
StoreMarker | undefined toString()
返回当前实例的marker列表并接成的字符串 string`},{header:"3 类型参考",slug:"_3-类型参考",content:""},{header:"3.1 MarkersSetting",slug:"_3-1-markerssetting",content:`全局markers设置列表类型
type MarkersSetting = { format: string | MarkerFormatFn // 参考类型 3.3 markers: { [key: string]: MarkersSettingItem | MarkersSettingItem[] // 参考类型 3.2 }
}[]`},{header:"3.2 MarkersSettingItem",slug:"_3-2-markerssettingitem",content:`单个marker设置类型
type MarkersSettingItem = { name: string tag?: string | string[] data?: { [key: string]: any }
}`},{header:"3.3 MarkerFormatFn",slug:"_3-3-markerformatfn",content:`全局设置时，可通过函数代替format，以更灵活的进行日期匹配。
type MarkerFormatFn = (lsr: Lunisolar) => string | null`},{header:"3.4 StoreMarker",slug:"_3-4-storemarker",content:`取得marker时的单个marker对象
type MarkersSettingItem = { name: string tag: string[] data?: { [key: string]: any }
}`},{header:"3.5 MarkerFilterDict",slug:"_3-5-markerfilterdict",content:`是markers.find和markers.filter的第一个参数的其中一种类型，是一个用于筛选的markers对象
type MarkerFilterDict = Partial<MarkersSettingItem> // 即
type MarkerFilterDict = { name?: string tag?: string | string[] data?: { [key: string]: any }
}`},{header:"3.6 MarkerFilterFn",slug:"_3-6-markerfilterfn",content:"是markers.find和markers.filter的第一个参数的其中一种类型，是一个用于筛选的函数，其函数与筛选数组时所用到的filter方法一致。 type MarkersFilterFn = (item: StoreMarker, index?: number, arr?: StoreMarker[]) => boolean"}]},{path:"/api/pillar.html",title:"Pillar 四柱类",pathLocale:"/",contents:[{header:"Pillar 四柱类",slug:"pillar-四柱类",content:`四柱类是SB类的增强版,主要补充了十神和神煞等属性 属性或方法
描述
参数
返回类型 gods
...
☱
011
3`}]},{path:"/reference/",title:"参考",pathLocale:"/",contents:[{header:"参考",slug:"参考",content:""}]},{path:"/reference/direction24.html",title:"二十四山与九宫数",pathLocale:"/",contents:[{header:"二十四山与九宫数",slug:"二十四山与九宫数",content:""},{header:"二十四山",slug:"二十四山",content:"二十四山图"},{header:"九宫数",slug:"九宫数",content:`4 东南
9 南
2 西南 3 东
5 中
7 西 8 东北
1 北
6 西北`}]},{path:"/reference/festival.html",title:"内置节日",pathLocale:"/",contents:[{header:"内置节日",slug:"内置节日",content:`通过 import festivals from 'lunisolar/markers/festivals.zh' 或
import festivals from 'lunisolar/markers/festivals.zh-cn' 可取得繁体或简体版的内置节日， 这些节日为： format
matcher
name
name(简体)
tag
...
国际罕见病日
international, health
2月的最后一天 (通过特定函数匹配取得)`}]},{path:"/reference/fetalGod.html",title:"胎神占方",pathLocale:"/",contents:[{header:"胎神占方",slug:"胎神占方",content:""},{header:"胎神逐日占游方定局",slug:"胎神逐日占游方定局",content:"《胎神逐日占游方定局》"},{header:"口诀",slug:"口诀",content:""},{header:"天干六甲胎神歌",slug:"天干六甲胎神歌",content:`甲己之日占在門，乙庚碓磨休移动。
丙辛廚灶莫相干，丁壬倉庫忌修弄。
...
先天八卦即伏羲八卦，後天八卦即文王八卦 先天八卦与後天八卦`}]},{path:"/guide/",title:"文档",pathLocale:"/",contents:[{header:"",slug:"",content:`前言
快速上手
功能与使用 解析
公历
阴历
...
丑月
小寒
大寒 实际上，节气是某一个时刻，而这个时刻并不是固定在某天的某个时辰。但由于数据源只精确到日，所以本库的交节（更换八字月柱），也是以日为准。`},{header:"* 生肖和换岁",slug:"生肖和换岁",content:`我们知道天干地支是基于二十四节气来定的。对于一些术数，如八字命理，通常以立春换岁，即到了立春，便更换下一个天干地支纪年，例如今年为甲子年，则到下一个立春，则换成乙丑年。
但是，并不是所有术数都是以立春换岁，例如中医的五运六气，则以大寒日换岁。 而奇门遁甲则以冬至换岁，中气换月。 lunisolar是为术数服务的， 所以lunisolar默认使用立春换岁, 当然你也可以自定义换岁的节气。 生肖：生肖与十二地支是对应的，所以实际上生肖也是按节气更换，所以生肖默认也是按立春更换。
另外，根据 中国大陆国家标准：编号GB/T 33661-2017 『农历的编算和颁行』规定, “干支纪年的循环参考时间：对应于北京时间公历1984年2月2日0时起到1985年2月19日24时截止的农历年为甲子年。” 如按此标准的话，应该正月初一换岁，即生肖在正月初一更换。
这样的好处是方便大众记忆与使用，但与传统术数的计算方式有所冲突，对术数并无任何指导意义。
由于大部分术数系统并不以正月初一换岁，所以lunisolar默认并不跟随此标准进行换岁（虽然可以通过配置设置成与国标一致，但不建议）。`},{header:"* 换日",slug:"换日",content:`子时是每一天的开始，子时对应的时间为 [23:00, 01:00), 为了方便一天的时辰吉凶计算，所以lunisolar会在23:00进行换日。 Tips
子时作为一天的第一个时辰，究竟是以子时正中（0:00）换日，还是以23：00作为换日？这种争论从古时一直便有，八字也因此有 “区分早晚子时” 和 “不区分早晚子时” 的两派。lunisolar的八字工具暂时会以23:00换日，日后会考虑在新版本的八字增强插件中增加区分此两派的设置选项。`},{header:"* 其它",slug:"其它",content:"moment.js 和 dayjs 是两个比较出名的时间工具库，为了符合大家的使用习惯，lunisolar针对公历的部分操作将会尽量向dayjs看齐，并参考了其代码设计。针对公历部分，尽管lunisolar也有类似dayjs的方法，但并不会cover其所有功能，如果你仅仅是对公历进行操作，推荐使用dayjs。lunisolar重点在于农历部分，例如Lunisolar的format方法和diff方法包含dayjs这两个方法的功能并与之保持一致，同时加入了对农历的处理，具体功能及使用请继续阅读文档。"},{header:"对象关系参考",slug:"对象关系参考",content:"lunisloar采用面向对象开发，下图可以帮助了解各个对象关系。"}]},{path:"/guide/i18n.html",title:"国际化",pathLocale:"/",contents:[{header:"国际化",slug:"国际化",content:`lunisolar返回数据默认用繁体中文，主要考虑到这类使用人群往往有繁体需求，而且繁体也易于直接翻译成简体（由于一简对多繁，繁体可直接转为简体，但简体不能直接转为繁体）。
...
}).format('YYYY-MM-DD') // 2022-11-18 使用神煞插件查宜忌
// 引入lunisolar
import lunisolar from 'lunisolar'
// 引入 theGods 插件
...
d24.direction // 南
d24.name // 午
d24.angle // 180`}]},{path:"/reference/acts/",title:"宜忌用事",pathLocale:"/",contents:[{header:"宜忌用事",slug:"宜忌用事",content:`宜忌等第
用事`}]},{path:"/reference/acts/actsCate.html",title:"用事",pathLocale:"/",contents:[{header:"用事",slug:"用事",content:`参考
...
凡岁薄逐阵日所宜事照月厌所忌删所忌仍从本日二月甲戌四月丙申六月甲子七月戊申八月庚辰九月辛卯十月甲子十二月甲子徳合与赦愿所㑹之辰诸事不忌`},{header:"宜忌推算流程",slug:"宜忌推算流程",content:""}]},{path:"/reference/gods/",title:"吉凶神煞",pathLocale:"/",contents:[{header:"吉凶神煞",slug:"吉凶神煞",content:""}]},{path:"/guide/functional/",title:"功能与使用",pathLocale:"/",contents:[{header:"",slug:"",content:`解析
公历
阴历
节气
八字
...
年、月、日、时用天干地支表示，分别称为年柱、月柱、日柱、时柱，所以八字又称为四柱 Tips
lunisolar().char8提功简单的八字查询功能，
如果你想取得更强的八字功能，可使用八字增强版插件 Lunisolar实例上包含char8属性，返回一个Char8实例，可取得相应天干支地支信息`},{header:"对象关系图",slug:"对象关系图",content:""},{header:"年柱",slug:"年柱",content:`取得年柱， 返回一个天干地支对象
...
lunisolar('2022/03/10').format('cZ年') // '虎年' // 提示： 使用方括号[]可对里边的内容进行转义, 如要显示Year这个单词，要放在[]内才能正确显示。
...
上/下午，小写 dR 1 ~ 5
该天的星期几在该月第 多少 次出现 dRr 1 ~ 5
该天的星期几在该月倒数第 多少 次出现`}]},{path:"/guide/functional/gregorian.html",title:"公历",pathLocale:"/",contents:[{header:"公历",slug:"公历",content:"通过lunisolar()函数创建Lunisolar后，可以取得一些基本的公历时间相关值"},{header:"取值",slug:"取值",content:""},{header:"年",slug:"年",content:`/** * @return {number} */
...
一个阴历月约为29.53天，12个月共 12∗29.53=354.3612 * 29.53 = 354.3612∗29.53=354.36 天。而一个回归年为365.2422日。一年就相差365.2422−354.36=10.88365.2422 - 354.36 = 10.88365.2422−354.36=10.88天，所以大概2.7年就要闰一个月来补回每年相差的时间。所以存在闰月 Lunisolar实例上包含一个lunar属性，该属返回一个Lunar实例可以此取得各项阴历数据
...
/** * @return {Date} */
lunisolar.Lunar.getLunarNewYearDay()`}]},{path:"/guide/functional/markers.html",title:"节日、日期备注",pathLocale:"/",contents:[{header:"节日、日期备注",slug:"节日、日期备注",content:`从2.3.0版本开始，可以通过**Markers**类添加日期备注，可用于添加节日、备忘等。
lunisolar内置了中国的各类节日列表, 全局加载后，可通过lunisolar().markers实例取得该天的节日。 你也可以自定义添加日期节日、备忘等。 通过以下几个列子，可快速上手。 Tips
对于lunisolar来说，所有节日实际上都是marker。`},{header:"1 快速上手",slug:"_1-快速上手",content:`例: 全局添加内置的节日列表
import lunisolar from 'lunisolar'
// 载入节日列表
import festivals from 'lunisolar/markers/festivals.zh' // 繁体版
// import festivals from 'lunisolar/markers/festivals.zh-cn' // 简体版 // 全局加载节日列表
lunisolar.Markers.add(festivals) // lunisolar('2023-10-01')实例下
const markersList = lunisolar('2023-10-01').markers.list console.log(markersList.map(v => v.name).join(',')) // 國際音樂節,國慶節 例：全局添加自定义的节日和日期备注
import lunisolar from 'lunisolar'
import type { MarkersSetting } from 'lunisolar' // 编写自定义的节日列表
const markersSetting: MarkersSetting = [{ format: 'MMDD', // 将会使用lunisolar().format('MMDD')方法格式化日期 markers: { '1019': { // 如果format方法返回值与此key匹配，则为当前日期会取得此marker tag: '生日', name: '我的生日' }, '0919': { tag: ['生日', '吐槽'], // tag可以是数组 name: '假的生日', data: { // 可以通过data，设定任何信息以便取用 desc: '身份证是的生日写早了一个月, 所以公司都提早一个月给我庆生', color: '#aa0000' } } }
}, { format: 'lMn,lDn', // 农历月日 markers: { '4,14': { // 农历四月十四 tag: '生日', name: '吕洞宾诞辰', data: { desc: '西樵山大仙诞交通管制', color: '#00cccc' } } }
}] // 再编写自定义的日期备注列表
const markersSetting2: MarkersSetting = [{ format: 'MMDD', // 将会使用lunisolar().format('MMDD')方法格式化日期 markers: { '1003': [{ //同一日期可以设定多个marker tag: '任务', name: '带家人出去吃饭' }, { tag: ['任务', '保险'], name: '交汽车保险' }] }
}] // 加载自定义的节日
// Markers类add静态方法支持链式操作，add方法的第二参数可为节日列表全补打一个标签
lunisolar.Markers.add(markersSetting, '自定义节日').add(markersSetting2, '自定义备忘') // lunisolar()实例的markers实例，可以取得对应日期marker数据 const lsr1003 = lunisolar('2023-10-03').markers.list // markers.list 取得markers数据列表
console.log(lsr1003.map(v => v.name)) // ['带家人出去吃饭', '交汽车保险'] const lsr0919 = lunisolar('2023-09-19')
console.log(lsr0919.markers.toString()) // '假的生日'
console.log(lsr0919.markers.find({name:'假的生日'})?.data?.desc) // '身份证是的生日写早了一个月, 所以公司都提早一个月给我庆生' // 全局删除指定tag的marker
lunisolar.Markers.removeByTag('吐槽') console.log(lunisolar('2023-09-19').markers.toString()) // 没有marker，输出空字符串 // 但是原来已生成的实例并不会移除marker
console.log(lsr0919.markers.toString()) // '假的生日'
// 可在markers实例上使用reset方法重置该实例上的全局marker
lsr0919.markers.reset()
console.log(lsr0919.markers.toString()) // 没有marker，输出空字符串 例：直接在lunisolar()实例上添加日期备注
import lunisolar from 'lunisolar' // 可直接在指定的lunisolar().markers实例上添加该日的marker
const lsr = lunisolar('2023-10-30')
lsr.markers.add({name: '买电烙铁', tag: '买东西'}) // 多个markers可以以数组形式传入，或者以链式操作添加
lsr.markers.add([{name: '练习多宝塔碑'}, {name: '临摹经飞经'}], '学习').add({name: '补充lunisolar.Markers相关文档', tag: '任务'}) console.log(lsr.markers.toString()) // '买电烙铁,练习多宝塔碑,临摹经飞经,补充lunisolar.Markers相关文档' // 因为不是全局添加，其它实例即使日期相同，也取不到上边设置的这些marker
console.log(lunisolar('2023-10-30').markers.list) // []`},{header:"2 添加marker",slug:"_2-添加marker",content:""},{header:"2.1 全局添加节日marker",slug:"_2-1-全局添加节日marker",content:`lunisolar內置了一系列的节日，但需要另外加载，其包含了简体版和繁体版。 Info
lunisolar內置的节日markers请参考[参考/内置节日] import festivals from 'lunisolar/markers/festivals.zh' // 繁体版
// import festivals from 'lunisolar/markers/festivals.zh-cn' // 简体版 lunisolar.Markers.add(festivals, '补充的标签名称') // 尽管节日设定列表已都有标签tag属性， 但Marker类的add静态方法的第二个参数可再为所有节日再补充标签，此参数为选填。`},{header:"2.2 全局添加自定义的marker",slug:"_2-2-全局添加自定义的marker",content:`除内置的节日外，你也可以自定义Marker, 自定义时，请参考类型 MarkersSetting 的规则
lunisolar.Markers.add(markersSetting: MarkersSetting, tag?: string|string[])
参数： markersSetting: MarkersSetting 自定义的节日设置，必填
tag?: string | string[] 补充的标签，可以是一个或多个，多个时为数组形式 例： import lunisolar from 'lunisolar'
import type { MarkersSetting } from 'lunisolar' // 编写写自定义的日期备注列表
const markersSetting: MarkersSetting = [{ format: 'MMDD', // 将会使用lunisolar().format('MMDD')方法格式化日期 markers: { // 以日期为key '1103': { tag: '纪念日', name: '结婚纪念日' } //同一日期可以设定多个marker '1104': [{ tag: '抄经', name: '临写灵飞经' }, { tag: ['车保'], // tag也可以是数组 name: '买汽车保险' data: { // data字段可以设置任何补充数据 desc: '每年不得不买' } }], }
}] // 加载自定义的节日
// Markers类add静态方法支持链式操作，add方法的第二参数可为节日列表全补打一个标签
lunisolar.Markers.add(markersSetting, '自定义节日').`},{header:"2.3 添加lunisolar实例上的marker",slug:"_2-3-添加lunisolar实例上的marker",content:`除了可以全局添加marker外，还可以单独在实例上添加ｍarker
const lsr = lunisolar()
lsr.markers.add(marker: MarkersSettingItem | MarkersSettingItem[], tag?: string | string[])
参数： marker: MarkersSettingItem | MarkersSettingItem[] 一个或多个的marker设置 tag?: string | string[] 补充的标签，可以是一个或多个，多个时为数组形式 返回: 返回当前markers实例 例： const lsr = lunisolar('2023-11-02')
lsr.markers.add({name: '今天下班要去加油'， tag: '备忘'}) // 第二个参数和静态方法Markers.add方法一样，可补充一个或多个标签，可以是字符串形式，也可以是数组
lsr.markers.add({name: '今天下班要去加油'}, '再强调')`},{header:"3 取得markers",slug:"_3-取得markers",content:`通过lunisolar().markers取得markers实例。
lunisolar会根据当前日期匹配对应marker自动注入到markers实例中。
// 取得当前lunisolar实例上的markers实例
const markers = lunisolar().markers`},{header:"3.1 取得markers列表",slug:"_3-1-取得markers列表",content:`通过lunisolar().markers.list属性，可取得一个marker列表，其返回的数据类型为 StoreMarker[]
const list:StoreMarker[] = lunisolar().markers.list
使用lunisolar().markers.toString()方法，可取得当前实例的所有marker名称
lunisolar().markers.toString(): string
例
import festivals from 'lunisolar/markers/festivals.zh' // 繁体版 lunisolar.Markers.add(festivals, '节日') const lsr = lunisolar('2023-10-23')
lsr.markers.add({ name: '测试', tag: 'test' }) lsr.markers.list.map(v => v.name) // ['重陽節', '测试'] // toString 方法相当于 lsr.markers.list.map(v => v.name).join(',')
lsr.markers.toString() // '重陽節,测试`},{header:"3.2 筛选和查找markers",slug:"_3-2-筛选和查找markers",content:`使用 lunisolar().markers.filter(fn) 进行列表筛选 参数fn类型为 MarkerFilterFn | MarkerFilterDict 返回的数据类型为 StoreMarker[] 使用 lunisolar().markers.find(fn) 查找一个合条件的marker, 参数fn类型为 MarkerFilterFn | MarkerFilterDict 返回数据类型为StoreMarker 例
import lunisolar from 'lunisolar'
// 载入节日列表
import festivals from 'lunisolar/markers/festivals.zh-cn' // 简体版 // 全局加载节日列表
lunisolar.Markers.add(festivals, '节日') const lsr = lunisolar('2023-03-03')
lsr.markers.add({ name: '抄经', tag: 'work', data: { desc: '临写一次经飞经' } }) lsr.markers.toString() // '世界野生动植物日,全国爱耳日,国际爱耳日,抄经' lsr.markers.find({ name: '世界野生动植物日' }) /** return:
{ tag: ['international', 'environment', '节日'] name: '世界野生动植物日'
} */ lsr.markers.find(v => v.name === '抄经')?.data?.desc ?? '' // '临写一次经飞经' lsr.markers .filter({ tag: 'health' }) .map(v => v.name) .join(',') // '全国爱耳日,国际爱耳日'`},{header:"4 删除marker",slug:"_4-删除marker",content:""},{header:"4.1 全局删除marker",slug:"_4-1-全局删除marker",content:"有些内置节日你是不想要的，可全局手动删除。"},{header:"4.1.1 通过标签删除marker",slug:"_4-1-1-通过标签删除marker",content:"lunisolar.Markers.removeByTag(tag: string | string[]): typeof lunisolar.Markers"},{header:"4.1.2 通过marker名称删除marker",slug:"_4-1-2-通过marker名称删除marker",content:"lunisolar.Markers.removeByName(name: string | string[]): typeof lunisolar.Markers"},{header:"4.1.3 删除指定日期的marker",slug:"_4-1-3-删除指定日期的marker",content:`lunisolar.Markers.remove(format: string, matcher?: string, name?: string | string[]): typeof lunisolar.Markers
参数： format: string 日期的格式化方式，如'MMDD' matcher?: string 指定的日期，如'0101'， 非必填 names?: string | string[] 指定的名称，非必填。 注意
如果只填format参数，所有与format一致的markers会全部删除，如果format与matcher参数都填上，如format: 'MMDD', matcher: '0303', 则会把lunisolar().format('MMDD')为0303的所有markers删除， 如果 name参数也指定，指会只删除指定name的marker 例 import festivals from 'lunisolar/markers/festivals.zh' // 繁体版 // 添加marker
lunisolar.Markers.add(festivals) // 删除所有包含 “traditional” 标签的节日
lunisolar.Markers.removeByTag('traditional') // 所有加进来的传统节日将被删除 // 删除指定名称的节日
lunisolar.Markers.removeByName('元旦') // 删除所有format为'MMDD'， 日期为 '0512' 的所有节日
lunisolar.Markers.remove('MMDD', '0512') // 國際護士節 和 全國防災減災日 都删除了 // 删除所有format为 'lMn,lDn'的节日
lunisolar.Markers.remove('lMn,lDn') // 所有内置的农历节日都删除了`},{header:"4.2 删除实例上的marker",slug:"_4-2-删除实例上的marker",content:`删除当前markers实例上的marker，并不会影响其它实例。每个lunisolar实例是安全隔离的。
markers.remove(name: string | string[], isTag: boolean, flag: 0 | 1 | 2): Markers
参数： name: string | string[] 要移除的marker名称或该marker的标签名称,可以以数组形式输入多个名称 isTag?: boolean 参数name是否指定为marker的标签名称，默认为false，即指定为marker名称。 flag?: 0 | 1 | 2 1：只移除从全局设定进本实例的markers
2：只移除通过本实例add方法加进来的markers
0：包括1和2。默认为0 例
const lsr = lunisolar('2023-01-01') // 传入指定的marker名称即可
lsr.markers.remove('元旦') // 即使是以全局方式注入本实例的节日，删除了只影响本实例，不影响其它实例 // 第二个参数为true时，第一个参数为标签名
lsr.markers.remove('备忘', true) // 第三个参数可填入0或1或2，
// 1: 只移除以全局方式注入本实例的markers, 2： 只移除通过本实例add方法加进来的markers, 0: 包括1和2。默认为0
lsr.markers.remove('傳統節日', true, 2)`},{header:"5 清除marker",slug:"_5-清除marker",content:""},{header:"5.1 全局清除marker",slug:"_5-1-全局清除marker",content:`注意
此方法可以清除全局markers，但已生成实例的markers并不会被清除 lunisolar.Markers.clean() // 所有全局添加的marker都被清除`},{header:"5.2 清除实例上的marker",slug:"_5-2-清除实例上的marker",content:`清除当前实例上的marker并不会影响其它实例
const lsr = lunisolar('2023-01-01')
lsr.markers.clean()`},{header:"6 重置实例marker",slug:"_6-重置实例marker",content:`重置当前实例，执行此方法时，将清除所有在本实例单独添加的markers, 并重新在全局设置的markers里找到匹配的marker添加到本实例
const lsr = lunisolar('2023-01-01')
lsr.markers.reset()`}]},{path:"/guide/functional/parse.html",title:"解析 (创建Lunisolar对象)",pathLocale:"/",contents:[{header:"解析 (创建Lunisolar对象)",slug:"解析-创建lunisolar对象",content:""},{header:"lunisolar()",slug:"lunisolar",content:`通过lunisolar() 函数创建一个 Lunisolar实例对象：
...
正因为神煞和宜忌的数据复杂烦琐，为了方便维护和以免影响lunisolar的打包体积，故TheGods作为一个lunisolar的插件开发。`},{header:"2 快速上手",slug:"_2-快速上手",content:""},{header:"安装",slug:"安装",content:`pnpm add @lunisolar/plugin-thegods yarn add @lunisolar/plugin-thegods npm install @lunisolar/plugin-thegods 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
...
参数:
参数与getGods方法一致, 默认值为 "MD"`},{header:"6.3 getBadGods方法",slug:"_6-3-getbadgods方法",content:`取得指定指定年、月、日、时的凶神
...
Direction24`}]},{path:"/reference/gods/godBuilder/",title:"神煞立成",pathLocale:"/",contents:[{header:"神煞立成",slug:"神煞立成",content:""}]},{path:"/reference/gods/godBuilder/dayGods.html",title:"日神",pathLocale:"/",contents:[{header:"日神",slug:"日神",content:`参考
...
午木死申木绝也
以上所宜`}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],I="update-vuepress-plugin-full-text-search2-search-index";var L=M(N),z=G(()=>{const n=new Map;for(const e of L.value)n.set(e.path,e);return n});import.meta.webpackHot&&(__VUE_HMR_RUNTIME__[I]=n=>{L.value=n});function j(n){const e=M([]);let o=null;return P(n,()=>{o&&clearTimeout(o),o=setTimeout(a,100)}),e;function a(){const u=n.value.toLowerCase().trim();if(!u){e.value=[];return}const l=new Map,r=new Set;for(const t of L.value)for(const s of q(t,u)){r.add(s.parentPageTitle);let i=l.get(s.parentPageTitle);i||(i=[],l.set(s.parentPageTitle,i)),i.push(s)}const c=[...r].sort((t,s)=>{const i=l.get(t);return l.get(s).length-i.length});e.value=[...l].flatMap(([,t])=>t).sort((t,s)=>t.parentPagePriority-s.parentPagePriority||c.indexOf(t.parentPageTitle)-c.indexOf(s.parentPageTitle)||t.priority-s.priority)}}function*q(n,e){const o=b(n.title,e);if(o){yield{path:n.path,parentPageTitle:S(n),title:n.title,display:o,page:n,content:null,parentPagePriority:1,priority:1};return}for(const a of n.contents){const u=b(a.header,e);if(u){yield{path:n.path+(a.slug?`#${a.slug}`:""),parentPageTitle:S(n),title:n.title,display:u,page:n,content:null,parentPagePriority:10,priority:2};continue}const l=b(a.content,e);l&&(yield{path:n.path+(a.slug?`#${a.slug}`:""),parentPageTitle:S(n),title:n.title,display:[{type:"header",str:`${a.header}
`},...l],page:n,content:null,parentPagePriority:10,priority:10})}}function S(n){const e=n.path.split("/");let o="/";return e[1]&&(o=`/${e[1]}/`),(z.value.get(o)||n).title}function b(n,e){const o=[];let a=0;const u=n.toLowerCase().replace(/\s/gu," ");let l=0,r=u.indexOf(e,l);if(r<0)return null;for(;r>=0;){const t=r+e.length;if(c(n.slice(l,r),"normal"),c(n.slice(r,t),"highlight"),l=t,r=u.indexOf(e,l),a>100)break}return c(n.slice(l),"normal"),o.filter(t=>t.str);function c(t,s){let i=t;s==="normal"&&i.length>100&&a===0&&(i=`… ${i.slice(-10)}`);let m=!1;if(a+i.length>100){if(o.some(f=>f.type==="ellipsis"))return;i=i.slice(0,Math.max(100-a,1)),m=!0}o.push({type:s,str:i}),a+=i.length,m&&(o.push({type:"ellipsis",str:" …"}),a+=2)}}const R={},K=_({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>R}},setup(n){const{locales:e}=E(n),o=M(""),a=M(!1),u=M(-1),l=j(o),r=G(()=>o.value&&a.value&&l.value.length),c=U(),t=H(),s=G(()=>e.value[t.value]??{});function i(){if(!r.value)return;let d=u.value-1;d<0&&(d=l.value.length-1),f(d)}function m(){if(!r.value)return;let d=u.value+1;d>=l.value.length&&(d=0),f(d)}function f(d){u.value=d}function C(){u.value=-1}function x(d){if(!r.value)return;const T=l.value[d];T&&c.push(T.path)}return{query:o,focused:a,focusIndex:u,suggestions:l,activeSuggestion:r,onUp:i,onDown:m,focus:f,unfocus:C,go:x,locale:s}}});const $={class:"search-box",role:"search"},Z=["placeholder"],V=["onMousedown","onMouseenter"],W=["href"],J={key:0,class:"parent-page-title"},X={class:"suggestion-row"},Q={class:"page-title"},nn={class:"suggestion-content"};function en(n,e,o,a,u,l){return g(),h("div",$,[O(p("input",{ref:"input","onUpdate:modelValue":e[0]||(e[0]=r=>n.query=r),"aria-label":"Search",class:k({focused:n.focused}),placeholder:n.locale.placeholder??"Search",autocomplete:"off",spellcheck:"false",onFocus:e[1]||(e[1]=()=>n.focused=!0),onBlur:e[2]||(e[2]=()=>n.focused=!1),onKeyup:[e[3]||(e[3]=D(r=>n.go(n.focusIndex),["enter"])),e[4]||(e[4]=D((...r)=>n.onUp&&n.onUp(...r),["up"])),e[5]||(e[5]=D((...r)=>n.onDown&&n.onDown(...r),["down"]))]},null,42,Z),[[A,n.query]]),n.activeSuggestion?(g(),h("ul",{key:0,class:"suggestions",onMouseleave:e[7]||(e[7]=(...r)=>n.unfocus&&n.unfocus(...r))},[(g(!0),h(v,null,Y(n.suggestions,(r,c)=>(g(),h("li",{key:c,class:k(["suggestion",{focused:c===n.focusIndex}]),onMousedown:t=>n.go(c),onMouseenter:t=>n.focus(c)},[p("a",{href:r.path,onClick:e[6]||(e[6]=F(()=>{},["prevent"]))},[r.parentPageTitle&&(!n.suggestions[c-1]||n.suggestions[c-1].parentPageTitle!==r.parentPageTitle)?(g(),h("div",J,y(r.parentPageTitle),1)):B("v-if",!0),p("div",X,[p("div",Q,y(r.title||r.path),1),p("div",nn,[(g(!0),h(v,null,Y(r.display,(t,s)=>(g(),h("span",{key:s,class:k(t.type)},y(t.str),3))),128))])])],8,W)],42,V))),128))],32)):B("v-if",!0)])}const ln=w(K,[["render",en],["__scopeId","data-v-c13c90dc"],["__file","SearchBox.vue"]]);export{ln as default};
