import{a as H}from"./app-adf72532.js";import{r as y,h as T,w as P,c as E,a2 as U,B as O,_ as A,V as g,W as h,a3 as w,a4 as N,X as f,a5 as b,a6 as G,a7 as Y,a8 as k,a9 as S,a1 as C,aa as _}from"./framework-d1125686.js";import"./preload-helper-101896b7.js";const I=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
- date: number 指定日期 - config: { lang?: string, returnValue?: boolean 返回值的第一个元素是返回SolarTerm对象，还是返回节气索引，默认为ture, 即返回节气索引。 nodeFlag: number 0,1,2三个值可选，默认0，0返回节之后，1返回气之后，2返回最近的节气之后}
