import{a as E}from"./app-3b5cb862.js";import{r as y,h as T,w as C,c as H,a1 as w,B as A,_ as N,V as g,W as h,a2 as O,a3 as _,X as f,a4 as G,a5 as b,a6 as k,a7 as x,a8 as v,a9 as S,aa as I}from"./framework-54e49b68.js";const z=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
☱
011
3`}]},{path:"/guide/",title:"文档",pathLocale:"/",contents:[]},{path:"/guide/about.html",title:"前言",pathLocale:"/",contents:[{header:"前言",slug:"前言",content:""},{header:"* 为何制作此库",slug:"为何制作此库",content:"昔见不同版本日历（包括纸质日历和各类日历软件），其所示宜忌有所不同，更有相矛盾者，不知如何取用，故疑其推算依据是否误，本着宏扬传统文化之精神，查阅各资料文案，以制此库。"},{header:"* 阴历和阳历",slug:"阴历和阳历",content:`现所用的中国传统历法，我们常称为农历，农历是阴阳合历，即包含了阴历和阳历，所以此库取lunar+solar，命名为lunisolar。
...
d24.direction // 南
d24.name // 午
d24.angle // 180`}]},{path:"/guide/plugins/",title:"插件 plugins",pathLocale:"/",contents:[{header:"插件 plugins",slug:"插件-plugins",content:""}]},{path:"/guide/plugins/about.html",title:"基本说明",pathLocale:"/",contents:[{header:"基本说明",slug:"基本说明",content:""},{header:"官方插件",slug:"官方插件",content:`lunisolar内置了一些插件，包括以下这些：
具体请参看对应插件的文档 插件
介绍
- fetalGod
胎神占方
...
const c8 = lunisolar().char8ex(1) // 参数0为坤造，1为乾造`},{header:"年柱",slug:"年柱",content:`取得年柱， 返回一个四柱对象
...
/** * @return {TenGod[]} */
pillar.branchTenGod`},{header:"四柱神煞",slug:"四柱神煞",content:`Pillar神煞上包含一个gods属性，可取得该柱所有神煞，返回 C8God实例列表
/** * @return {C8God[]} */
pillar.gods`},{header:"Char8Ex类",slug:"char8ex类",content:`通过 lunisolar().char8ex(sex: 0 | 1): Char8Ex取得Char8Ex实例 为什么char8ex方法要设置性别参数？
因为个别神煞的计算方法男女不同。 属性或方法
描述
参数
返回类型 me
取得日主 Stem sexValue
...
SB toString()
返回八字的基本信息描述
SB`},{header:"Pillar 四柱类",slug:"pillar-四柱类",content:`四柱类是SB类的增强版,主要补充了十神和神煞等属性 属性或方法
描述
参数
返回类型 gods
返回该柱所算出的所有神煞 C8God[] stem
...
取得地支十神, 因为是按地支藏干算的, 所以返回提一个列表 TenGod[] missing
返回旬空地支 [Branch, Branch] toString()
该天干地支组合的字符串, 等同于name属性 string`},{header:"C8God 四柱神煞类",slug:"c8god-四柱神煞类",content:`属性或方法
描述
参数
返回类型 luckLevel
吉凶等级, 1为吉, -1凶, 0不定 number key
该神煞的key(以繁体中文神煞名作为key) string name
该神煞名 string toString()
该天干地支组合的字符串, 等同于name属性 string`},{header:"TenGod 十神类",slug:"tengod-十神类",content:`属性或方法
描述
参数
返回类型 key
该十神的key(以繁体中文神煞名作为key) string name
该十神名称 string toString()
该天干地支组合的字符串, 等同于name属性 string`}]},{path:"/guide/plugins/fetalGod.html",title:"胎神占方",pathLocale:"/",contents:[{header:"胎神占方",slug:"胎神占方",content:`古人认为怀孕以及孕期胎儿的好坏都与胎神有关。所以民间传统习俗里，家里一旦有孕妇，便有各种禁忌，以免惊动胎神。
...
忌3
取得本日民用所忌
string[]`}]},{path:"/guide/functional/",title:"功能与使用",pathLocale:"/",contents:[]},{path:"/guide/functional/branch.html",title:"地支",pathLocale:"/",contents:[{header:"地支",slug:"地支",content:`通过SB实例的branch属性可取得天干对象Branch
// 例如，取得年柱的地支
...
年、月、日、时，分别用天干地支表示，分别称为年柱、月柱、日柱、时柱，所以八字又称为四柱 Lunisolar实例上包含char8属性，返回一个Char8实例，可取得相应天干支地支信息`},{header:"年柱",slug:"年柱",content:`取得年柱， 返回一个天干地支对象
...
节气是某一个时该点，而非某个时间段，但由于本库采用的转换数据只精确到天，所以本库的交节（更换八字月柱），也是以日为准。`},{header:"取得当前节气",slug:"取得当前节气",content:`返回当前日期的节气对象，如果不是节气，返回null
...
/** * @return {string[]} */
lunisolar.Stem.getNames()`}]},{path:"/404.html",title:"",pathLocale:"/",contents:[]}],q="update-vuepress-plugin-full-text-search2-search-index";var B=y(z),j=T(()=>{const n=new Map;for(const e of B.value)n.set(e.path,e);return n});import.meta.webpackHot&&(__VUE_HMR_RUNTIME__[q]=n=>{B.value=n});function F(n){const e=y([]);let l=null;return C(n,()=>{l&&clearTimeout(l),l=setTimeout(a,100)}),e;function a(){const i=n.value.toLowerCase().trim();if(!i){e.value=[];return}const o=new Map,t=new Set;for(const r of B.value)for(const s of K(r,i)){t.add(s.parentPageTitle);let u=o.get(s.parentPageTitle);u||(u=[],o.set(s.parentPageTitle,u)),u.push(s)}const d=[...t].sort((r,s)=>{const u=o.get(r);return o.get(s).length-u.length});e.value=[...o].flatMap(([,r])=>r).sort((r,s)=>r.parentPagePriority-s.parentPagePriority||d.indexOf(r.parentPageTitle)-d.indexOf(s.parentPageTitle)||r.priority-s.priority)}}function*K(n,e){const l=D(n.title,e);if(l){yield{path:n.path,parentPageTitle:L(n),title:n.title,display:l,page:n,content:null,parentPagePriority:1,priority:1};return}for(const a of n.contents){const i=D(a.header,e);if(i){yield{path:n.path+(a.slug?`#${a.slug}`:""),parentPageTitle:L(n),title:n.title,display:i,page:n,content:null,parentPagePriority:10,priority:2};continue}const o=D(a.content,e);o&&(yield{path:n.path+(a.slug?`#${a.slug}`:""),parentPageTitle:L(n),title:n.title,display:[{type:"header",str:`${a.header}
`},...o],page:n,content:null,parentPagePriority:10,priority:10})}}function L(n){const e=n.path.split("/");let l="/";return e[1]&&(l=`/${e[1]}/`),(j.value.get(l)||n).title}function D(n,e){const l=[];let a=0;const i=n.toLowerCase().replace(/\s/gu," ");let o=0,t=i.indexOf(e,o);if(t<0)return null;for(;t>=0;){const r=t+e.length;if(d(n.slice(o,t),"normal"),d(n.slice(t,r),"highlight"),o=r,t=i.indexOf(e,o),a>100)break}return d(n.slice(o),"normal"),l.filter(r=>r.str);function d(r,s){let u=r;s==="normal"&&u.length>100&&a===0&&(u=`… ${u.slice(-10)}`);let m=!1;if(a+u.length>100){if(l.some(p=>p.type==="ellipsis"))return;u=u.slice(0,Math.max(100-a,1)),m=!0}l.push({type:s,str:u}),a+=u.length,m&&(l.push({type:"ellipsis",str:" …"}),a+=2)}}const $={},U=H({name:"SearchBox",props:{locales:{type:Object,required:!1,default:()=>$}},setup(n){const{locales:e}=w(n),l=y(""),a=y(!1),i=y(-1),o=F(l),t=T(()=>l.value&&a.value&&o.value.length),d=A(),r=E(),s=T(()=>e.value[r.value]??{});function u(){if(!t.value)return;let c=i.value-1;c<0&&(c=o.value.length-1),p(c)}function m(){if(!t.value)return;let c=i.value+1;c>=o.value.length&&(c=0),p(c)}function p(c){i.value=c}function Y(){i.value=-1}function P(c){if(!t.value)return;const M=o.value[c];M&&d.push(M.path)}return{query:l,focused:a,focusIndex:i,suggestions:o,activeSuggestion:t,onUp:u,onDown:m,focus:p,unfocus:Y,go:P,locale:s}}});const V={class:"search-box",role:"search"},Z=["placeholder"],R=["onMousedown","onMouseenter"],W=["href"],X={key:0,class:"parent-page-title"},J={class:"suggestion-row"},Q={class:"page-title"},nn={class:"suggestion-content"};function en(n,e,l,a,i,o){return g(),h("div",V,[O(f("input",{ref:"input","onUpdate:modelValue":e[0]||(e[0]=t=>n.query=t),"aria-label":"Search",class:G({focused:n.focused}),placeholder:n.locale.placeholder??"Search",autocomplete:"off",spellcheck:"false",onFocus:e[1]||(e[1]=()=>n.focused=!0),onBlur:e[2]||(e[2]=()=>n.focused=!1),onKeyup:[e[3]||(e[3]=b(t=>n.go(n.focusIndex),["enter"])),e[4]||(e[4]=b((...t)=>n.onUp&&n.onUp(...t),["up"])),e[5]||(e[5]=b((...t)=>n.onDown&&n.onDown(...t),["down"]))]},null,42,Z),[[_,n.query]]),n.activeSuggestion?(g(),h("ul",{key:0,class:"suggestions",onMouseleave:e[7]||(e[7]=(...t)=>n.unfocus&&n.unfocus(...t))},[(g(!0),h(k,null,x(n.suggestions,(t,d)=>(g(),h("li",{key:d,class:G(["suggestion",{focused:d===n.focusIndex}]),onMousedown:r=>n.go(d),onMouseenter:r=>n.focus(d)},[f("a",{href:t.path,onClick:e[6]||(e[6]=I(()=>{},["prevent"]))},[t.parentPageTitle&&(!n.suggestions[d-1]||n.suggestions[d-1].parentPageTitle!==t.parentPageTitle)?(g(),h("div",X,S(t.parentPageTitle),1)):v("v-if",!0),f("div",J,[f("div",Q,S(t.title||t.path),1),f("div",nn,[(g(!0),h(k,null,x(t.display,(r,s)=>(g(),h("span",{key:s,class:G(r.type)},S(r.str),3))),128))])])],8,W)],42,R))),128))],32)):v("v-if",!0)])}const an=N(U,[["render",en],["__scopeId","data-v-c13c90dc"],["__file","SearchBox.vue"]]);export{an as default};
