...
export const monthGods = {
  月神取月建三合者: {
    ...
    三合: [[[4, 8],[5,9], [6, 10], [7, 11], [8, 0], [1, 9], [2, 10], [3, 11], [0, 4], [1, 5], [2, 6], [3, 7]], 'branch', 'branch', 4],
  ...
  月神从厌建起者: {
    ...
    陽錯: [[null, [49], [50], [51], [40], [53, 5], null, [43, 55], [56], [57], [46], [59]], 'branch', 'sb', -4],
    陰錯: [[null, [59], [46], [57], [56], [43, 31], null, [53, 3], [40], [51], [50], [49]], 'branch', 'sb', -4],
    陰陽俱錯: [(()=>{
      return (new Array(12)).fill(0).map((v, i)=>{
        if (i === 1) return 48
        if (i === 6) return 42
