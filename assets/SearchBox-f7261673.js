import{a as E}from"./app-592b8c90.js";import{r as y,h as T,w as H,c as C,a2 as w,B as A,_ as N,V as g,W as h,a3 as O,a4 as _,X as f,a5 as G,a6 as b,a7 as k,a8 as Y,a9 as S,a1 as v,aa as I}from"./framework-d1125686.js";const z=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
Direction24`}]},{path:"/reference/acts/",title:"宜忌用事",pathLocale:"/",contents:[{header:"宜忌用事",slug:"宜忌用事",content:""}]},{path:"/reference/acts/actsCate.html",title:"用事",pathLocale:"/",contents:[{header:"用事",slug:"用事",content:""},{header:"御用六十七事",slug:"御用六十七事",content:"...编撰中"},{header:"民用三十事",slug:"民用三十事",content:"...编撰中"},{header:"通书选择六十事",slug:"通书选择六十事",content:"...编撰中"}]},{path:"/reference/acts/actsLevel.html",title:"宜忌等第",pathLocale:"/",contents:[{header:"宜忌等第",slug:"宜忌等第",content:`参考
参考《钦定协纪辨方书》卷十`},{header:"宜忌等第表",slug:"宜忌等第表",content:""},{header:"铺注条例",slug:"铺注条例",content:`凡铺注万年书通书先依用事次第察其所宜忌之日于某日下注宜某事某日下注忌某事次按宜忌较量其吉凶之轻重以定去取
凡宜宣政事布政事之日止注宜宣政事
凡宜营建宫室修宫室之日止注宜营建宫室
...
凡岁薄逐阵日所宜事照月厌所忌删所忌仍从本日二月甲戌四月丙申六月甲子七月戊申八月庚辰九月辛卯十月甲子十二月甲子徳合与赦愿所㑹之辰诸事不忌`}]},{path:"/reference/gods/",title:"吉凶神煞",pathLocale:"/",contents:[{header:"吉凶神煞",slug:"吉凶神煞",content:""}]},{path:"/reference/gods/godBuilder/",title:"神煞立成",pathLocale:"/",contents:[{header:"神煞立成",slug:"神煞立成",content:""}]},{path:"/reference/gods/godBuilder/dayGods.html",title:"日神",pathLocale:"/",contents:[{header:"日神",slug:"日神",content:`参考
...
义同除日`},{header:"五合",slug:"五合",content:`宜宴㑹结婚姻立劵交易
见义例`},{header:"宝日 义日 制日",slug:"宝日-义日-制日",content:`与吉神并宜安抚边境选将训兵出师
