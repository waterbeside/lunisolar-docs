import{_ as e,V as i,W as t,X as n,Y as a,$ as c,a0 as d,Z as r,F as l}from"./framework-54e49b68.js";const p={},o=n("h1",{id:"地支",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#地支","aria-hidden":"true"},"#"),a(" 地支")],-1),u=n("strong",null,"Branch",-1),m=r(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 例如，取得年柱的地支</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35);function v(h,b){const s=l("RouterLink");return i(),t("div",null,[o,n("p",null,[a("通过SB实例的branch属性可取得天干对象"),c(s,{to:"/api/branch.html"},{default:d(()=>[u]),_:1})]),m])}const g=e(p,[["render",v],["__file","branch.html.vue"]]);export{g as default};
