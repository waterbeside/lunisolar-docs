import{_ as t,V as p,W as i,X as s,Y as n,$ as o,a0 as c,Z as a,F as l}from"./framework-d1125686.js";const u={},r=a('<h1 id="节气" tabindex="-1"><a class="header-anchor" href="#节气" aria-hidden="true">#</a> 节气</h1><div class="hint-container info"><p class="hint-container-title">Info</p><ul><li>节气是农历的重要组成部分，依黄经度数划分，属于阳历范畴，是天干地支纪时法的换岁换月依据，是中国大多数传统术数的重要基础</li><li>自1645年起至今所使用的廿四节气是依据太阳黄经度数划分，把黄道360度圆周划分成24等份，每等份15度，每15度为一个节气，全年共二十四个节气。</li><li>节气是某一个时该点，而非某个时间段，但由于本库采用的转换数据只精确到天，所以本库的交节（更换八字月柱），也是以日为准。</li></ul></div><h2 id="取得当前节气" tabindex="-1"><a class="header-anchor" href="#取得当前节气" aria-hidden="true">#</a> 取得当前节气</h2>',3),d=s("strong",null,"SolarTerm",-1),m=a(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token doc-comment comment">/**
