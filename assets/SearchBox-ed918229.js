import{a as E}from"./app-ef198da0.js";import{r as y,h as T,w as H,c as C,a1 as w,B as A,_ as N,V as g,W as h,a2 as O,a3 as _,X as f,a4 as b,a5 as G,a6 as k,a7 as Y,a8 as S,a9 as v,aa as I}from"./framework-ad9ccf37.js";const z=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
寅申火爐休要动，卯酉大門修当避。
辰戌雞棲巳亥床，犯着六甲身堕胎。`}]},{path:"/reference/gods.html",title:"吉凶神煞",pathLocale:"/",contents:[{header:"吉凶神煞",slug:"吉凶神煞",content:""},{header:"神煞推算",slug:"神煞推算",content:"编写中..."},{header:"神煞吉凶",slug:"神煞吉凶",content:"编写中..."},{header:"宜忌等次表",slug:"宜忌等次表",content:"编写中..."}]},{path:"/reference/stemBranch.html",title:"天干地支",pathLocale:"/",contents:[{header:"天干地支",slug:"天干地支",content:""},{header:"天干",slug:"天干",content:""},{header:"地支",slug:"地支",content:"地支掌诀"},{header:"60甲子",slug:"_60甲子",content:""},{header:"冲、破、刑、害、合",slug:"冲、破、刑、害、合",content:""},{header:"地支三合",slug:"地支三合",content:`地支三合
五行 亥卯未
木 寅午戌
火 巳酉丑
金 申子辰
