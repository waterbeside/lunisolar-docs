import{a as E}from"./app-3a2cbc94.js";import{r as y,h as T,w as H,c as C,a1 as w,B as A,_ as N,V as g,W as h,a2 as O,a3 as _,X as f,a4 as b,a5 as G,a6 as k,a7 as Y,a8 as S,a9 as v,aa as I}from"./framework-ad9ccf37.js";const z=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
