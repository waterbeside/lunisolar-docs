import{a as H}from"./app-52c140c1.js";import{r as y,h as T,w as E,c as C,a2 as w,B as A,_ as N,V as g,W as h,a3 as O,a4 as _,X as f,a5 as b,a6 as G,a7 as k,a8 as Y,a9 as S,a1 as v,aa as I}from"./framework-d1125686.js";const j=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
加载char8ex插件时，将自动加载takeSound插件（五行纳音插件），所以请不要再重复加takeSound`},{header:"快速上手",slug:"快速上手",content:""},{header:"安装",slug:"安装",content:`pnpm install @lunisolar/plubin-char8ex yarn add @lunisolar/plubin-char8ex npm install @lunisolar/plubin-char8ex 注意
...
其中天干地支与胎神位置的规律可用以下口诀记忆： ----天干六甲胎神歌---- 甲己之日占在門，乙庚碓磨休移动。 丙辛廚灶莫相干，丁壬倉庫忌修弄。 戊癸房床若移整，犯之孕妇堕孩童。 ----地支六甲胎神歌---- 子午二日碓须忌，丑未廁道莫修移。 寅申火爐休要动，卯酉大門修当避。 辰戌雞棲巳亥床，犯着六甲身堕胎。`},{header:"安装",slug:"安装",content:`pnpm install @lunisolar/plubin-fetalgod yarn add @lunisolar/plubin-fetalgod npm install @lunisolar/plubin-fetalgod 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
...
sb.takeSoundE5 属性返回纳音五行的Element5实例`},{header:"安装",slug:"安装",content:`pnpm install @lunisolar/plubin-takesound yarn add @lunisolar/plubin-takesound npm install @lunisolar/plubin-takesound 注意
使用lunisolar@2.x版本时，lunisolar包已内置有该插件，
