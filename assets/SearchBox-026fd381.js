import{a as E}from"./app-33b37f36.js";import{r as y,h as T,w as C,c as H,a1 as w,B as A,_ as N,V as g,W as h,a2 as O,a3 as _,X as f,a4 as G,a5 as b,a6 as k,a7 as x,a8 as v,a9 as S,aa as I}from"./framework-54e49b68.js";const z=[{path:"/",title:"项目主页",pathLocale:"/",contents:[]},{path:"/api/",title:"API",pathLocale:"/",contents:[{header:"API",slug:"api",content:"此处会进行各种类的说明"}]},{path:"/api/branch.html",title:"Branch 地支类",pathLocale:"/",contents:[{header:"Branch 地支类",slug:"branch-地支类",content:`属性或方法
描述
参数
返回类型 value
...
1回归年 = 365.2421990741日 = 365天5小時48分46秒
1回归年=365.2421990741日=365天5小時48分46秒`},{header:"* 节和气",slug:"节和气",content:`我们常说的二十四节气，其实分为节和气两种，共十二节和十二气，节和气交替出现。天干地支纪月是以节换月的。 节
气 孟春
寅月
立春
雨水 春
...
const branch = lunisolar().char8.year.branch // 取得年柱的SB实例`},{header:"地支名",slug:"地支名",content:`/** * @return {string} */
